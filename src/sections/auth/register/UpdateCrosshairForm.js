...
export default function UpdateCrosshairForm(props) {
  ...
  const onSubmit = async (e) => {
    ...
    axiosConfig.post('/crosshair/update',objectSubmit)
    .then((response) =>{
      setLoading(false);
      setError(false);
...
React.useEffect(()=>{
  axiosConfig.post('/crosshair/get',{_id: slug, token: cookies.token})
  .then((res)=>{
